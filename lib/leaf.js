...
var Leaf = createClass({
    ...
    render: function() {
        ...
        return React.createElement('div', { className: this.getClassName(), id: 'leaf-' + this._rootPath() },
          ...
          React.createElement('label', { className: 'json-inspector__line', htmlFor: id, onClick: onLabelClick },
            React.createElement('div', { className: 'json-inspector__flatpath' },
              d.path),
            React.createElement('span', { className: 'json-inspector__key' },
              this.format(d.key),
              ':',
    ...
    renderTitle: function() {
        ...
        switch (t) {
            ...
            default:
                return React.createElement('span', { className: 'json-inspector__value json-inspector__value_' + t.toLowerCase() },
